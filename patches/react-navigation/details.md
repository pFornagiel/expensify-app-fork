...
#### [@react-navigation+core+7.14.0+001+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+core+7.14.0+001+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+elements+2.9.5+001+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+elements+2.9.5+001+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+material-top-tabs+7.4.13+001+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+material-top-tabs+7.4.13+001+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+native-stack+7.13.0+002+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+native-stack+7.13.0+002+fix-failing-jest-by-disabling-esmodule.patch)
#### [@react-navigation+native+7.1.28+002+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+native+7.1.28+002+fix-failing-jest-by-disabling-esmodule.patch)
...
#### [@react-navigation+stack+7.7.2+003+fix-failing-jest-by-disabling-esmodule.patch](@react-navigation+stack+7.7.2+003+fix-failing-jest-by-disabling-esmodule.patch)
...
### [@react-navigation+core+7.14.0+002+platform-navigation-stack-types.patch](@react-navigation+core+7.14.0+002+platform-navigation-stack-types.patch)
...
### [@react-navigation+core+7.14.0+003+fix-clearing-preloaded-routes-after-logout.patch](@react-navigation+core+7.14.0+003+fix-clearing-preloaded-routes-after-logout.patch)
...
### [@react-navigation+native-stack+7.13.0+001+added-interaction-manager-integration.patch](@react-navigation+native-stack+7.13.0+001+added-interaction-manager-integration.patch)
...
### [@react-navigation+native+7.1.28+001+initial.patch](@react-navigation+native+7.1.28+001+initial.patch)
...
### [@react-navigation+stack+7.7.2+001+edge-drag-gesture.patch](@react-navigation+stack+7.7.2+001+edge-drag-gesture.patch)
...
### [@react-navigation+stack+7.7.2+002+dontDetachScreen.patch](@react-navigation+stack+7.7.2+002+dontDetachScreen.patch)
